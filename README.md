...
Em cada arquivo, fiz o GET, POST, PUT e DELETE de cada tabela ( cada arquivo da model corresponde a uma tabela que criei lá no incío no banco de dados no MySQL ).

Até o momento estou na pasta controller, onde também vou desenvolver quatro arquivos, um para cada tabela que criei. Nesse arquivo preciso criar o req e o res de cada método para todos ( clube, campeonato, jogador e partida ).